...
const TaxBillUser = () => {
  ...
  }, [id, getTaxPayerById, getTaxRateById, getTaxPayerBillById, getBankAccountById]);
  ...
  return (
    <Container fluid className="p-4 tax-bill">
      ...
      {/* Print Button */}
      <div className="d-flex justify-content-center mt-4 no-print gap-2">
