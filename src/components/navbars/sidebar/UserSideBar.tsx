...
const UserSideBar: React.FC<UserSideBarProps> = ({ showMenu, toggleMenu }) => {
      ...
      <SimpleBar style={{ maxHeight: "100vh" }}>
        <div className="nav-scroller">
          <Link to="/dashboard" className="navbar-brand">
            <Image src="/images/brand/logo/logo.png" alt=""  style={{ height: "60px", width: "auto" }} />
          </Link>
        </div>
        {/* Dashboard Menu */}
        <Accordion
